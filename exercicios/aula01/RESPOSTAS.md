...
* **Projeto investigado:** Sistema Integrado de Administração de Recursos Humanos e Folha de Pagamento em município brasileiro de médio porte (dados extraídos de auditorias públicas do TCE/TCU).
* **Desfecho:** O contrato foi rescindido pela administração pública após estouro do prazo contratual em mais de 12 meses e aditivos financeiros superiores a 35% do valor inicial, sem que o módulo principal de folha de pagamento pudesse entrar em operação plena.
* **Causas recorrentes da aula presentes:** Requisitos mal definidos, cronogramas e prazos irreais, e falta de envolvimento contínuo dos operadores (usuários finais) no desenho da ferramenta.
* **Fonte:** Relatórios públicos de auditoria e acórdãos de controle externo disponíveis nos portais oficiais do Tribunal de Contas da União (TCU) e Tribunais de Contas Estaduais (TCE).
